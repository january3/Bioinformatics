...
First, we need to install a few packages (installing `fpc` will install
them all). We will also install BiocManager (Bioconductor package manager),
...
**Exercise. (5')**. What happens if you seemply run `plot(tree_hclust)`? Take
...
clusters do you see? You are free to use whichever method is available.

---

## Differential gene expression analysis

This part of the exercise which will be, at this point, mostly a
demonstration.
