...
## Sequence logos
 ...
 1. Use the online tool to create sequence logos from the following sets of
    sequences:
...
There are three data sets: 
  ...
  2. Data set 2 are the different human globin sequences.
  3. Data set 3 are different human bHLH proteins. There are more than 150
