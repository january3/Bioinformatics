---
title: "Lecture 11: Beginning of Life"
...
Water can be detected using 18 O / 16 O ratio: water loses 18O and the
 ...
 * 1979 – 2014: 3.7 Ga
 * 2001: 3.8 Ga
 * 2019: 3.95 Ga (during LHB!)
 * some report even 4.1 Ga (prior to LHB)
   ]

.pull-right[

 * Oldest "crown" Eukaryota fossils: 1.1 Ga (?1.6 Ga)
 * Oldest Eukaryota: 1.6 Ga

![](images/history_of_life.png)

???

life started almost immediately after the Late Heavy Bombardment, or even
earlier (models indicate that LHB would not have been enough to sterilize
the planet)
...
![:scale 75%](images/wisniak_viruses.png)
...
# Approach 2: Phylogeny reconstructions
 ...
 * Used supertrees:
  * calcualte a tree for each gene family
 ...
 * used paleontological evidence for calibration - used as constraints
 * explored a variety of models and approaches
 * LUCA older than the late heavy bombing....!
 * methanogenesis older (3.5 Ga) than "crown" Eukaryotes
...
evolution, involving an *error threshold*. 
...
## How about bottom-down approach?
...
*Synthia* a.k.a. *Mycoplasma laboratorium*

 * *M. genitalium* has a very small genome (482)
 * Non-essential genes were identified experimentally
 * only 382 genes
 * genomic DNA de novo synthesized in vitro
...
---
class:empty-slide,myinverse
background-image:url(images/synthia_scheme.png)

???

the point is: that is still far too complex to explain to us how life arose
in the first place
...
![:scale 75%](images/white_smoker_chemistry.png)
...
---
class:empty-slide,myinverse
background-image:url(images/life_history_10_b.png)

---
class:empty-slide,myinverse
background-image:url(images/life_history_25_b.png)

---
class:empty-slide,myinverse
background-image:url(images/life_history_50_b.png)

---
class:empty-slide,myinverse
background-image:url(images/life_history_90_b.png)
