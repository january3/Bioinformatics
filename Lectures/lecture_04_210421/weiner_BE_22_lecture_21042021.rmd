---
title: "Lecture 4: Multiple alignments, motifs, domains"
...
$H_i = -20 \cdot 0.05 \cdot \log2 0.05 \approx -20 \cdot 0.05 \cdot -4.3 = 4.3$
...
$$S_i = \sum{j=1}{N} \sum{k=j + 1}{N} aa_{i,j,k}$$

Score for the full alignment:

$$S = \sum_{i=1}^L \sum{j=1}{N} \sum{k=j + 1}{N} aa_{i,j,k}$$
